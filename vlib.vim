...
silent fun! DoAltMap(prefix, key1, operation, ...)
    ...
    if IsOSX()
        let s:d = { 'a': 'å', 'A': 'Å', 'b': '∫', 'B': 'ı', 'c': ' ', 'C': 'Ç', 'd': '∂', 'D': 'Î', 'e': ' ', 'E': '´', 'f': 'ƒ', 'F': 'Ï', 'g': '©', 'G': '˝', 'h': '˙', 'H': 'Ó', 'i': ' ', 'I': 'ˆ', 'j': '∆', 'J': 'Ô', 'k': '˚', 'K': '', 'l': '¬', 'L': 'Ò', 'm': 'µ', 'M': 'Â', 'n': ' ', 'N': '˜', 'o': 'ø', 'O': 'Ø', 'p': 'π', 'P': '∏', 'q': 'œ', 'Q': 'Œ', 'r': '®', 'R': '‰', 's': 'ß', 'S': 'Í', 't': '†', 'T': 'ˇ', 'u': ' ', 'U': '¨', 'v': '√', 'V': '◊', 'w': '∑', 'W': '„', 'x': '≈', 'X': '˛', 'y': '¥', 'Y': 'Á', 'z': 'Ω', 'Z': '¸', '-': '–', '_': '—', '=': '≠', '+': '±', '[': '“', '{': '”', ']': '‘', '}': '’', ';': '…', ':': 'æ', "'": 'æ', '"': 'Æ', ',': '≤', '<': '¯', '.': '≥', ">": '˘', '/': '÷', "?": '¿' }
